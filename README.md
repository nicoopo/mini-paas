...
Dashboard sur `http://127.0.0.1:8090`. Ajoute un projet (nom, URL du repo, port hôte, port conteneur
— 80 par défaut), clique **Déployer**. La requête reste ouverte le temps du clone+build+run et affiche
la sortie complète en dessous.
...
- Toujours la branche par défaut du remote, pas de choix de branche/tag.
